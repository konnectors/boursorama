[Cozy][cozy] Konnector Boursorama Bank
=======================================
...
This konnector retrieves your banking data from Boursorama bank.
...
cozy-konnector-boursorama is developed by [Orandin](https://github.com/orandin) and distributed under the [AGPL v3 license][agpl-3.0].
